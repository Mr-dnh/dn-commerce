      ...
      <article
        ...
        <Link href={`/products/${product.product_id}`}>
          <div className="relative aspect-4/3 overflow-hidden bg-slate-200 dark:bg-slate-600">
            ...
            />
            <span className="absolute left-4 top-4 rounded-full bg-slate-950/85 px-3 py-1 text-xs font-bold uppercase tracking-[0.18em] text-white dark:bg-slate-800/90">
              {product.brand}
            </span>
          </div>
        </Link>
        <div className="flex flex-1 flex-col p-5 gap-5">
          <div className="flex items-start justify-between">
            ...
            <p className="rounded-full bg-slate-100 px-3 py-1 text-sm font-black text-slate-900 whitespace-nowrap dark:bg-slate-600 dark:text-white">
