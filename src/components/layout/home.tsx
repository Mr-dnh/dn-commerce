...
export default async function Home() {
  ...
  return (
    <main className="bg-slate-500 text-slate-950">
      <section className="relative isolate overflow-hidden bg-slate-900 px-4 py-20 text-white sm:px-6 lg:px-8">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1fr_0.9fr]">
          ...
          <div className=" hidden sm:block text-center text-8xl">Your Logo</div>
        </div>
      </section>
      ...
      <section
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.3em] text-slate-200">
              Featured Collection
            </p>
          ...
          <Link
            href="/products"
            className="text-sm font-bold text-white hover:bg-slate-600 transition rounded-full px-3 py-2">
            View all →
          </Link>
        </div>
        ...
        <div className="mt-7 grid sm:grid-cols-[2fr_1fr] items-center justify-items-center">
          <span className="hidden sm:block text-sm">Wanna see more?</span>
          <Link
            href="/products"
            className="font-bold text-lg text-white hover:bg-slate-600 transition rounded-full px-3 py-2">
            View all →
          </Link>
        </div>
      </section>
